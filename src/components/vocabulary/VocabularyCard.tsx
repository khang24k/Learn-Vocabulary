        ...
        <div className="flex flex-col sm:flex-row items-center gap-3">
          <div className="flex items-center gap-2 w-full sm:w-auto">
            ...
            <button
              ...
              className={`p-3 rounded-full transition-all focus:outline-none select-none [-webkit-touch-callout:none]${isRecording
          ...
          <div
            className={`relative flex items-center w-full sm:w-48 bg-slate-50 dark:bg-slate-900 border rounded-lg px-3 py-2 ${isCorrect ? 'border-green-400 dark:border-green-500 bg-green-50 dark:bg-green-900/20' : 'border-slate-200 dark:border-slate-600'
              }`}
            onClick={(e) => e.stopPropagation()}
          >
            <input
